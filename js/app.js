...
function faveColor() {
  ...
  //  faveColorArray[4]
  var faveColorArray = ['orange', 'pink', 'blue', 'yellow', 'green', 'black'];
  ...
  while (attempts < 6) {
    ...
    if (attempts !== 6) {
      faveColorPrompt = prompt(userName + ' nope not it. Guess again!'); 
    }
    attempts++;
  }
}
